...
export class Button extends Component {
    ...
    getButtonClasses() {
        const baseClasses =
            'tw-inline-flex tw-items-center tw-justify-center tw-font-medium tw-rounded-lg tw-transition-colors focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-offset-2';
        ...
        return `${baseClasses} ${sizeClasses[this.props.size]} ${
            variantClasses[this.props.variant]
        } ${disabledClasses}`;
    }
